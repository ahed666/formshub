...
<svg :class="[dimClass]" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" width="800px" height="800px" fill="#2d4b71" stroke="#2d4b71" stroke-width="0.00512">
...
<g id="SVGRepo_iconCarrier"> <g> 
  <ellipse :style="{ fill: color }" cx="256" cy="414.302" rx="93.936" ry="38.661"/> 
  <path :style="{ fill: color }" d="M265.404,414.302h-18.808c-5.771,0-10.449-4.678-10.449-10.449v-52.245h39.706v52.245 C275.853,409.624,271.175,414.302,265.404,414.302z"/> 
  <path :style="{ fill: color }" d="M483.265,351.608H28.735c-11.542,0-20.898-9.356-20.898-20.898V79.935 c0-11.542,9.356-20.898,20.898-20.898h454.531c11.542,0,20.898,9.356,20.898,20.898V330.71 C504.163,342.252,494.807,351.608,483.265,351.608z"/> </g> 
  <rect x="39.184" y="90.384" :style="{fill:color?'#e0e0e0':'#1277d1'}" width="433.633" height="219.429"/> 
...
<script>
  export default {
    ...
    props: {
        ...
        dimClass:{
          type:String,
          default:'w-16 h-16 xs:w-10 xs:h-10',
        },
    }
  }
</script>
