...
<svg  class="w-6 h-6 text-svg_primary hover:text-primary_red hover:cursor-pointer" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <title>{{ title }}</title><g id="SVGRepo_bgCarrier" stroke-width="0"/>
